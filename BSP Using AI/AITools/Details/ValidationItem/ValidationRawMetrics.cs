...
{
    public partial class ValidationRawMetrics : UserControl, DbStimulatorReportHolder, AIBackThreadReportHolder
    {
        ...
        public ValidationRawMetrics(Dictionary<string, ObjectiveBaseModel> objectivesModelsDic, ObjectiveBaseModel objectiveModel, CustomArchiBaseModel innerObjectiveModel)
        {
            InitializeComponent();
