...
{
    public partial class ValidationAccF1Score : UserControl, DbStimulatorReportHolder, AIBackThreadReportHolder
    {
        ...
        public ValidationAccF1Score(Dictionary<string, ObjectiveBaseModel> objectivesModelsDic, ObjectiveBaseModel objectiveModel, CustomArchiBaseModel innerObjectiveModel)
        {
            InitializeComponent();
